...
const theme = (darkMode, color) => ({
  ...
  uniswapPink: darkMode ? '#ff5900' : 'black',
  ...
  //primary colors
  primary1: darkMode ? '#2172E5' : '#ff5900',
  ...
  // color text
  primaryText1: darkMode ? '#6da8ff' : '#ff5900',

  // secondary colors
  secondary1: darkMode ? '#2172E5' : '#ff5900',
  ...
  background: darkMode ? 'black' : `radial-gradient(50% 50% at 50% 50%, #ff590030 0%, #fff 0%)`
})
