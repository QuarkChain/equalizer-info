...
const theme = (darkMode, color) => ({
  ...
  uniswapPink: darkMode ? '#ff8400' : 'black',
  ...
  //primary colors
  primary1: darkMode ? '#2172E5' : '#ff8400',
  ...
  // color text
  primaryText1: darkMode ? '#6da8ff' : '#ff8400',

  // secondary colors
  secondary1: darkMode ? '#2172E5' : '#ff8400',
  ...
  background: darkMode ? 'black' : `radial-gradient(50% 50% at 50% 50%, #ff840030 0%, #fff 0%)`
})
